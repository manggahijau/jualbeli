...
@section('content')
    <div class="py-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            {{-- Kartu Tambah Produk --}}
            <a href="{{ route('produk.create') }}" class="flex items-center justify-center bg-white rounded-lg shadow border-2 border-dashed border-gray-300 hover:border-blue-400 p-4 text-center">
                <div>
