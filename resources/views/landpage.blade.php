...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
            <div class="bg-white rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-shadow duration-200 cursor-pointer">
            ...
            <div class="bg-white rounded-xl shadow-lg p-6 text-center hover:shadow-xl transition-shadow duration-200 cursor-pointer">
                <div class="w-12 h-12 bg-yellow-100 rounded-lg flex items-center justify-center mx-auto mb-3">
                    <svg class="w-6 h-6 text-yellow-600" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M12 4.095c-1.393 0-2.656.452-3.69 1.258l-.05-.05c-1.25.968-2.062 2.278-2.316 3.738L4 12c.088 1.432.553 2.766 1.305 3.931l.006.01c.71.97 1.603 1.764 2.628 2.338l.05.028c1.034.567 2.193.893 3.407.893 1.214 0 2.373-.326 3.407-.893l.05-.028c1.025-.574 1.918-1.368 2.628-2.338l.006-.01c.752-1.165 1.217-2.499 1.305-3.931l-.039-2.959c-.254-1.46-1.066-2.77-2.316-3.738l-.05-.05c-1.034-.806-2.3-1.258-3.69-1.258zM12 6.095c.828 0 1.583.277 2.195.735l.024-.017c.563.385.932.936 1.092 1.564l.013.045c.162.628.162 1.3.007 1.928l-.013.045c-.16.628-.529 1.179-1.092 1.564l-.024.017c-.612.458-1.367.735-2.195.735s-1.583-.277-2.195-.735l-.024-.017c-.563-.385-.932-.936-1.092-1.564l-.013-.045c-.162-.628-.162-1.3-.007-1.928l.013-.045c.16-.628.529-1.179 1.092-1.564l.024-.017c.612-.458 1.367-.735 2.195-.735z"></path>
                    </svg>
                </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        <div class="flex items-center justify-between mb-8">
            ...
            <a href="/produk" class="text-blue-600 hover:text-blue-700 font-medium flex items-center">
                Lihat Semua 
